...
class IntentClassifier:
    ...
    def train(self):
        ...
        X_train_counts = self.count_vect.fit_transform(X_train) #count the number of words in each text
        ...
        self.clf = MultinomialNB().fit(X_train_tfidf, y_train) #create an instance of MultinomialNB class and train the model
